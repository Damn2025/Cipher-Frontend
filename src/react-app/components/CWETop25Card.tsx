...
export default function CWETop25Card({ vulnerability }: CWETop25CardProps) {
  ...
  return (
    <div className=" max-w-7xl group rounded-xl border border-gray-800 bg-gradient-to-br from-gray-900 to-gray-950 backdrop-blur-sm transition-all duration-300 hover:border-gray-700 overflow-hidden">
      <div
